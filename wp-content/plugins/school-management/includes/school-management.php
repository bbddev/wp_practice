...
function render_entity_meta_box($post)
{
    ...
    <p>
        ...
        <input type="text" id="entity_class" name="entity_class" value="<?php echo esc_attr($entity_class); ?>" style="width: 100%;" />
    </p>
    <p>
        <label for="entity_link">Link khi click:</label>
        <input type="text" id="entity_link" name="entity_link" value="<?php echo esc_attr($entity_link); ?>" style="width: 100%;" />
    </p>
    <p>
        <label for="entity_image">Hình:</label>
        <input type="text" id="entity_image" name="entity_image" value="<?php echo esc_attr($entity_image); ?>" style="width: 100%;" />
    </p>
